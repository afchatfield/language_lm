...
The bar is the strongest system it is measured against, **F0.5 = 0.5987** (fine-tuned-es-cw025), ahead of fine-tuned-es-cw1-e231's 0.5887. This model **does not beat** it.

## Detection versus correction

| | Detection F0.5 | Correction F0.5 | Gap |
|---|---:|---:|---:|
| fine-tuned-es | 0.6345 | 0.5360 | +0.0986 |
...
| | Value | Reads as |
|---|---:|---|
| Coverage | 0.9483 | of 5,822 rewrites it made, 5,521 were listed |
| Precision | 0.9817 | of 5,846 changes it listed, 5,739 match a real rewrite |
| Type accuracy | 0.8343 | of the 5,739 that match, 4,788 carry the type ERRANT assigns |
...
0 with no readable correction, 0 cut off but recovered, 2,380 left unchanged, out of 5,116 answers.
