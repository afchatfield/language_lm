...
|---|---:|---:|---:|
| trimmed-healed | 0.7420 | 0.6218 | +0.1202 |
...
|---|---:|---:|
| strict | 0.6991 | 0.6218 |
| lenient | 0.7037 | 0.6260 |
...
| | Value | Reads as |
|---|---:|---|
| Coverage | 0.8508 | of 5,548 rewrites it made, 4,720 were listed |
| Precision | 0.9099 | of 5,582 changes it listed, 5,079 match a real rewrite |
| Type accuracy | 0.6927 | of the 5,079 that match, 3,518 carry the type ERRANT assigns |
...
1 with no readable correction, 9 cut off but recovered, 1,017 left unchanged, out of 2,903 answers.
