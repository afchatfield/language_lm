...
|---|---:|---:|---:|
| trimmed-nohealing | 0.7467 | 0.6268 | +0.1199 |
...
|---|---:|---:|
| strict | 0.7061 | 0.6268 |
| lenient | 0.7109 | 0.6309 |
...
| | Value | Reads as |
|---|---:|---|
| Coverage | 0.8621 | of 5,663 rewrites it made, 4,882 were listed |
| Precision | 0.9161 | of 5,784 changes it listed, 5,299 match a real rewrite |
| Type accuracy | 0.6935 | of the 5,299 that match, 3,675 carry the type ERRANT assigns |
...
0 with no readable correction, 2 cut off but recovered, 993 left unchanged, out of 2,903 answers.
