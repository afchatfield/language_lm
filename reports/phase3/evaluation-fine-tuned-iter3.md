...
The bar is the best Phase 1 baseline, **F0.5 = 0.6944** (few-shot), not LanguageTool's 0.4134. This model **beats** it.

## Detection versus correction

| | Detection F0.5 | Correction F0.5 | Gap |
|---|---:|---:|---:|
| fine-tuned-iter3 | 0.7434 | 0.6219 | +0.1215 |
...
|---|---:|---:|
| strict | 0.6960 | 0.6219 |
| lenient | 0.7001 | 0.6256 |
...
| | Value | Reads as |
|---|---:|---|
| Coverage | 0.9012 | of 5,487 rewrites it made, 4,945 were listed |
| Precision | 0.9588 | of 5,514 changes it listed, 5,287 match a real rewrite |
| Type accuracy | 0.7229 | of the 5,287 that match, 3,822 carry the type ERRANT assigns |
...
0 with no readable correction, 6 cut off but recovered, 993 left unchanged, out of 2,903 answers.
