...
|---|---:|---:|---:|
| iter4-cw025-dpo-b5 | 0.7255 | 0.6008 | +0.1247 |
...
|---|---:|---:|
| strict | 0.6895 | 0.6008 |
| lenient | 0.6944 | 0.6052 |
...
| | Value | Reads as |
|---|---:|---|
| Coverage | 0.8288 | of 5,939 rewrites it made, 4,922 were listed |
| Precision | 0.9236 | of 5,774 changes it listed, 5,333 match a real rewrite |
| Type accuracy | 0.6750 | of the 5,333 that match, 3,600 carry the type ERRANT assigns |
...
0 with no readable correction, 7 cut off but recovered, 938 left unchanged, out of 2,903 answers.
