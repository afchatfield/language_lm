...
|---|---:|---:|---:|
| iter4-cw025-dpo | 0.7008 | 0.5775 | +0.1233 |
...
|---|---:|---:|
| strict | 0.6739 | 0.5775 |
| lenient | 0.6788 | 0.5818 |
...
| | Value | Reads as |
|---|---:|---|
| Coverage | 0.8143 | of 6,285 rewrites it made, 5,118 were listed |
| Precision | 0.9207 | of 6,028 changes it listed, 5,550 match a real rewrite |
| Type accuracy | 0.6582 | of the 5,550 that match, 3,653 carry the type ERRANT assigns |
...
0 with no readable correction, 8 cut off but recovered, 878 left unchanged, out of 2,903 answers.
